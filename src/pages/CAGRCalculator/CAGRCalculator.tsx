        ...
        <When truthy={typeof result !== 'undefined'}>
          <div className='w-full p-4 flex flex-col gap-4 items-center'>
            ...
            <div className='flex gap-2 border-b'>
              <div>Your absolute returns: </div>
              <div className='font-medium'>
                {moneyWithNotation(parseFloat(result?.summary?.absoluteReturns ?? '0'))} {preferences.currencyUnit}
              </div>
            </div>
            <div className='flex gap-2 border-b'>
              <div>Your absolute CAGR: </div>
              <div className='font-medium'>
                {result?.summary?.absoluteCAGR} {preferences.currencyUnit}
              </div>
            </div>
            <div className='flex gap-2 border-b'>
              <div>Your CAGR percentage: </div>
