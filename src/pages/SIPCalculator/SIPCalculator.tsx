              ...
              <div className='w-full p-4 flex flex-col gap-4 items-center'>
                <div className='flex gap-2 border-b'>
                  ...
                  <div className='font-medium'>
                    {moneyWithNotation(result?.summary?.totalInvested ?? 0)} {preferences.currencyUnit}
                  </div>
                </div>
                <div className='flex gap-2 border-b'>
                  <div>Final value: </div>
                  <div className='font-medium'>
                    {moneyWithNotation(result?.summary?.finalValue ?? 0)} {preferences.currencyUnit}
                  </div>
                </div>
                <div className='flex gap-2 border-b'>
                  <div>Wealth gained: </div>
                  <div className='font-medium'>
                    {moneyWithNotation(result?.summary?.wealthGained ?? 0)} {preferences.currencyUnit}
                  </div>
                </div>
